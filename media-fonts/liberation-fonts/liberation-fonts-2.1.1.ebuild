...
SRC_URI="!fontforge? ( https://github.com/liberationfonts/liberation-fonts/files/4743886/${PN}-ttf-${PV}.tar.gz )
fontforge? ( https://github.com/liberationfonts/liberation-fonts/files/4743885/${P}.tar.gz )"
