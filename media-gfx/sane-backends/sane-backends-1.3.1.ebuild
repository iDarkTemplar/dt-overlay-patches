...
SRC_URI="https://gitlab.com/sane-project/backends/-/archive/${PV}/backends-${PV}.tar.bz2 -> ${P}.tar.bz2"
...
src_prepare() {
	...
	sed \
		-e "s|m4_esyscmd_s(\[tools/git-version-gen --prefix '' .tarball-version\])|${PV}|" \
