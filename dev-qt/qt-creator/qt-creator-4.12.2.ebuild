...
QTC_PLUGINS=(android +autotest baremetal beautifier boot2qt
	...
	mcu:mcusupport mercurial modeling:modeleditor nim perforce perfprofiler python qbs:qbsprojectmanager
	+qmldesigner qmlprofiler qnx remotelinux scxml:scxmleditor serialterminal silversearcher subversion
	valgrind webassembly winrt)
...
src_prepare() {
	...
	rm -r src/libs/3rdparty/sqlite || die
