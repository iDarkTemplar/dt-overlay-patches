...
case ${PV} in
	...
	*)
		case ${PN} in
			assistant|linguist|qdbus|qdbusviewer|qtattributionsscanner|pixeltool)
				SLOT=0 ;;
...
qt5_tools_configure() {
	...
	for i in assistant designer linguist pixeltool qdbus qdoc qtdiag qtpaths qtplugininfo qtattributionsscanner; do
